...
minimal joycon2cpp/Switch 2 Pro initialization sequence, subscribes to input
report notifications, and logs received reports as hexdump / JSONL.
...
Usage:
  ...
  python3 tools/switch2_ble_probe.py --mode none       # only discover services + notify
  python3 tools/switch2_ble_probe.py --mode pair       # legacy CareyScott pair writes
